...
const displayStr = `
  A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${
    unfundedCount === 1 
      ? "1 game remains" : `${unfundedCount} games remain`} unfunded. We need your help to fund these amazing games!
`;


// create a new DOM element containing the template string and append it to the description container
const infoParagraph = document.createElement("p");
infoParagraph.innerText = displayStr;
...
const mostFundedElement = document.createElement("h3");
mostFundedElement.innerText = mostFunded.name;
firstGameContainer.appendChild(mostFundedElement);

const secondMostFundedElement = document.createElement("h3");
secondMostFundedElement.innerText = secondMostFunded.name;
